...
const calcAverageHumanAge = function (dogAges) {
  const humanAges = dogAges.map(dogAges =>
...
//   movement > 0
//     ? console.log(`Index ${i + 1} Round : Deposited ${movement}`)
//     : console.log(`Index ${i + 1} Round : Withdrew ${Math.abs(movement)}`);
// });

// const stationSet = new Set(['CBZ', 'DMR', 'PNS', 'CBZ']);
// stationSet.forEach(function (value, _, set) {
//   console.log(`${value}`);
// });
// stationSet.forEach(function (value, key, set) {
...
const checkDogs = function (dogsJulia, dogsKate) {
  const dogsJuliaCorrected = dogsJulia.slice(); //taking a shallow copy
...
checkDogs([5, 2, 1, 4, 7, 8, 0], [1, 2, 3]); */
// console.log(checkDogs([5, 2, 1], [1, 2, 3]));

// const rupee = [10, 20, 50];
// const rupeeUSD = rupee.map(function (rup) {
//   return rup * 80;
// });

// console.log(rupee);
// console.log(rupeeUSD);
...
const finalBalance = movements.reduce(
  (accumulator, currentValue) => accumulator + currentValue,
  0
);
// const finalBalance = movements.reduce(
//   (accumulator, currentValue, currentIndex, movements) => {
//     return accumulator + currentValue;
//   },
//   0
// );
// const finalBalance = movements.reduce(function (
//   accumulator,
//   currentValue,
//   currentIndex,
//   movements
...
// const amounts = [100, 200, 50, 400, 100];
// console.log(amounts.every(val => val > 0));

// const toUSD = 80;
// const totalAmountInUSD = amounts
//   .filter(val => val > 0)
//   .map(val => val * toUSD)
...
//1. Sum of all the deposits
// const bankDepositSum = accounts
//   .flatMap(acc => acc.movements)
//   .filter(mov => mov > 0)
//   .reduce((sum, curr) => sum + curr, 0); //reduce is to add all the ele
// console.log(bankDepositSum);

// const convertTitleCase = function (title) {
//   const capitalize = str => str[0].toUpperCase() + str.slice(1);
//   const exceptions = ['a', 'an', 'the', 'of'];
...
// console.log(convertTitleCase('my of name is ABHISHEK'));
// console.log(convertTitleCase('the crush name is dEBAlina'));
